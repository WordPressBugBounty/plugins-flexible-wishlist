	...
	<div class="fwSettings__footer">
		...
		echo wp_kses_post(
			...
			/* translators: %$1s: love icon, %$2s: anchor opening tag, %$3s: anchor closing tag, %$4s: anchor opening tag, %$5s: anchor closing tag */
				...
				'<a href="' . esc_attr( __( 'https://wpdesk.link/fw-settings-footer-wpdesk-link', 'flexible-wishlist' ) ) . '" target="_blank">',
				'</a>',
				'<a href="' . esc_attr( __( 'https://wpdesk.link/fw-settings-footer-review-link', 'flexible-wishlist' ) ) . '" target="_blank">',
